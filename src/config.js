...
export const CONFIG = {
  ...
  powerups: {
    ...
    doubleMaxMult: 8,
    loadoutGoals: 1,
    types: ['wide', 'shrink', 'slowmo', 'double', 'ghost', 'freeze', 'shield', 'echo', 'turbo'],
    colors: { wide: 0x00ff88, shrink: 0xff2d95, slowmo: 0x66aaff, double: 0xffff00, ghost: 0x9d7bff, freeze: 0x88ddff, shield: 0xffb347, echo: 0x18e0ce, turbo: 0xff3b30 },
  },
  drafts: {
    every: 5,
    timeout: 3,
